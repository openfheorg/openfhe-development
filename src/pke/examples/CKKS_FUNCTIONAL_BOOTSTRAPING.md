...
same manner as in regular CKKS bootstrapping: the number of overflows is bounded by K = 672 (probability of failure below 2^-77
for N = 2^16 and 2^-31 for N = 2^17 with full packing), and the complex exponential (or cosine, for the binary case) is
