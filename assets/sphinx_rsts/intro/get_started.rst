...
.. toctree::
   ...
   editor_setup.rst
   exceptions_in_palisade.rst


The high Level structure of the PALISADE library is as follows.
...
.. csv-table:: components
   ...
   "Description","Code for benchmarking PALISADE library components, using the Google Benchmark frameworks"
